...
<a href='index_structure.php?collapse={$data.ID}#{$data.ID}'><img src='../../images/minus.gif' valign='bottom' height='22' width='22' alt='Collapse Thread' border='0' /></a>
{elseif $settings.subnoexpand}
<a href='index_structure.php?expand={$data.ID}#{$data.ID}'><img src='../../images/plus.gif' valign='bottom' height='22' width='22' alt='Expand Thread' border='0' /></a>
{else}
<img src='../../images/spacer.gif' height='22' width='22' alt='' valign='bottom' />
{/if}
