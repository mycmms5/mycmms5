<!--
CVS
$Id: tab_wr0.tpl,v 1.2 2013/11/04 08:00:52 werner Exp $
$Source: /var/www/cvs/mycmms40/mycmms40/smarty/templates/tab_wr0.tpl,v $
$Log: tab_wr0.tpl,v $
Revision 1.2  2013/11/04 08:00:52  werner
CVS version shows

Revision 1.1  2013/08/31 09:04:59  werner
CVS variable $Id
...
-->
<table width="800">
<tr><td valign ="top" class="LABEL" width="30%">{t}DBFLD_TASKDESC{/t}</td>
...
-->
<!-- NEW Equipment Tree -->
<tr><td align="right"><a href="javascript:window.open('../libraries/tree_equip_select.php?tree_table=equip&return_form=treeform',
    'select_equip',
