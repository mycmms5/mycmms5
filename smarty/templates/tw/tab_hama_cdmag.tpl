...
{foreach item=cdmag from=$cdmags}
<tr bgcolor="{cycle values="WHITE,LIGHTSTEELBLUE"}">
{if $actual_id ne $cdmag.ID}
<form action="{$SCRIPT_NAME}" name="EDIT" method="get">
<input type="hidden" name="ACTION" value="EDIT">
<input type="hidden" name="form_save" value="SET">
<input type="hidden" name="ID" value="{$cdmag.ID}">
    <td style="text-align: center;">{$cdmag.ID}</td>
    <td style="text-align: center;">{$cdmag.CDID}</td>
    <td style="text-align: center;">{$cdmag.SubID}</td>
    <td style="text-align: center;">{$cdmag.HAMA}</td>
...
<input type="hidden" name="ID" value="{$cdmag.ID}">
    <td style="text-align: center;">{$cdmag.ID}</td>
    <td style="text-align: center;">{$cdmag.CDID}</td>
    <td style="text-align: center;"><input type="text" name="SubID" size="4" value="{$cdmag.SubID}" ></td>
    <td style="text-align: center;"><input type="text" name="HAMA" size="4" value="{$cdmag.HAMA}" style="text-align: center;"></td>
