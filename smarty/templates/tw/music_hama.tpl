...
<table>
<tr><th>ID</th><th>Record#</th><th>#</th><th>HAMA</th><th>Action</th></tr>
{foreach item=cd from=$cds}
<tr bgcolor="{cycle values="WHITE,LIGHTSTEELBLUE"}">
{if $actual_id ne $cd.ID}
...
<input type="hidden" name="ID" value="{$cd.ID}">
    <td style="text-align: center;">{$cd.ID}</td>
    <td style="text-align: center;">{$cd.RecordingID}</td>
    <td style="text-align: center;">{$cd.SubID}</td>
    <td style="text-align: center;">{$cd.HAMA}</td>
...
<input type="hidden" name="ID" value="{$cd.ID}">
    <td style="text-align: center;">{$cd.ID}</td>
    <td style="text-align: center;">{$cd.RecordingID}</td>
    <td style="text-align: center;"><input type="text" name="SubID" size="4" value="{$cd.SubID}" ></td>
    <td style="text-align: center;"><input type="text" name="HAMA" size="4" value="{$cd.HAMA}" style="text-align: center;"></td>
