 ...
 *
 * @package	DEBUG
 * @version	$Id: tsmarty2c.php,v 1.1.1.1 2013/04/16 05:14:40 werner Exp $
...
**/
echo "<H1>Reading Smarty Templates</H1>";
$filename="../../documents/resources/gettext_smarty.php";
...
do_dir(".");
echo "<P>Creation of GetText Smarty Source MO ($filename) is finished!</P>";
?>
