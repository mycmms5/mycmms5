...
* @filesource
* CVS
* $Id: global_weekplanning.php,v 1.8 2013/08/23 08:28:38 werner Exp $
* $Source: /var/www/cvs/mycmms40/mycmms40/actions/global_weekplanning.php,v $
* $Log: global_weekplanning.php,v $
...
GROUP BY PLANWEEK,TYPE",PDO::FETCH_ASSOC));
    if ($_REQUEST['1CLICK']=='on') {
        $tpl->display_error("global_weekplanning_list2.tpl");   
    } else {
        $tpl->display_error("action/weekplan_list01.tpl");
    }
    break;
} // EO STEP1
case "2": {
...
default: {
    ...
    $tpl->display_error("action/weekplan_form.tpl");
    break;
} // EO default
} // EO Switch
?>